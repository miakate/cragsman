...
export const environment = {
  ...
  url: 'https://api.lunarcrush.com/v2/assets?data=market&type=fast&key=rlxr6sz0zhi58jnrs19ji5',
  exchangeUrl: 'https://api.lunarcrush.com/v2/assets?data=exchanges&key=rlxr6sz0zhi58jnrs19ji5&limit=10&order_by=1d_trades',
